echo "--- Executing initialization force file for testWriteCode.vhd ---"
...
echo "Done initializing processor, loading testWriteCode.vhd program code."
run 5
...
run 5
echo "Done loading testWriteCode.vhd program code."
