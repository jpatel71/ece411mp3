...
ARCHITECTURE struct OF PipeLine IS
   ...
   FOR ALL : IsTrap USE ENTITY ece411.IsTrap;
   FOR ALL : LoadGenerator USE ENTITY ece411.LoadGenerator;
   FOR ALL : LoadLDISTI USE ENTITY ece411.LoadLDISTI;
   ...
   FOR ALL : Stall_ID USE ENTITY ece411.Stall_ID;
...
BEGIN
   ...
   theEX_Reg : State_Reg2
      PORT MAP (
         ...
         LoadOut           => LoadOut,
         MEMSEL_EX         => MEMSEL_EX,
         MEMSEL_MEM        => MEMSEL_MEM,
         D_Datain          => D_Datain,
         DATAIN_PREV       => DATAIN_PREV
      );
   ADDRESSMUX : WordMux2
      PORT MAP (
         A   => BR_add_EX,
