-- VHDL Entity ece411.Copy_of_PipeLine.symbol
--
-- Created:
--          by - bjohns38.stdt (eelnx37.ews.illinois.edu)
--          at - 18:12:50 11/06/10
--
...
END Copy_of_PipeLine ;

--
-- VHDL Architecture ece411.Copy_of_PipeLine.struct
--
-- Created:
--          by - bjohns38.stdt (eelnx37.ews.illinois.edu)
--          at - 18:12:50 11/06/10
...
ARCHITECTURE struct OF Copy_of_PipeLine IS
   ...
   FOR ALL : ALUSHFtoD1 USE ENTITY ece411.ALUSHFtoD1;
   FOR ALL : BR_add1 USE ENTITY ece411.BR_add1;
   FOR ALL : BRlog1 USE ENTITY ece411.BRlog1;
   FOR ALL : ControlReg1 USE ENTITY ece411.ControlReg1;
   FOR ALL : ControlSplit_EX1 USE ENTITY ece411.ControlSplit_EX1;
   FOR ALL : ControlSplit_ID1 USE ENTITY ece411.ControlSplit_ID1;
   FOR ALL : ControlSplit_MEM1 USE ENTITY ece411.ControlSplit_MEM1;
   FOR ALL : ControlSplit_WB1 USE ENTITY ece411.ControlSplit_WB1;
   FOR ALL : ControlWordReg USE ENTITY ece411.ControlWordReg;
   FOR ALL : GenCC USE ENTITY ece411.GenCC;
   FOR ALL : LoadGenerator1 USE ENTITY ece411.LoadGenerator1;
   FOR ALL : MUX2_16 USE ENTITY mp3lib.MUX2_16;
   FOR ALL : MUX2_3 USE ENTITY mp3lib.MUX2_3;
   FOR ALL : NZP USE ENTITY ece411.NZP;
   FOR ALL : Plus2 USE ENTITY ece411.Plus2;
   FOR ALL : READLOGIC1 USE ENTITY ece411.READLOGIC1;
   FOR ALL : REGFILE USE ENTITY mp3lib.REGFILE;
   FOR ALL : Reg16 USE ENTITY ece411.Reg16;
   FOR ALL : SHIFT16 USE ENTITY mp3lib.SHIFT16;
   FOR ALL : StateReg_31 USE ENTITY ece411.StateReg_31;
   FOR ALL : State_Reg11 USE ENTITY ece411.State_Reg11;
   FOR ALL : State_Reg21 USE ENTITY ece411.State_Reg21;
   FOR ALL : State_Reg3 USE ENTITY ece411.State_Reg3;
   FOR ALL : WordMux2 USE ENTITY ece411.WordMux2;
   FOR ALL : WordMux4 USE ENTITY ece411.WordMux4;
   FOR ALL : WriteLogic1 USE ENTITY ece411.WriteLogic1;
   FOR ALL : splitNZP1 USE ENTITY ece411.splitNZP1;
   -- pragma synthesis_on
...
BEGIN
   ...
   U_21 : ControlSplit_ID1
      PORT MAP (
         ControlWord_ID => ControlWord_ID,
         clk            => clk,
         SRCMuxSel      => SRCMuxSel
      );
   U_17 : ControlSplit_MEM1
      PORT MAP (
